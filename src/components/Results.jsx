...
import {Trophy,Target,Award,Clock,RefreshCw} from "lucide-react";
                ...
                <div className="grid gap-4 max-h-64 overflow-y-auto">
                    {questions.map((question,index)=>{
                        ...
                        return <div key={index} className={`flex items-center justify-between p-4 rounded-lg border-2 ${isCorrect?"border-green-200 bg-green-50": "border-red-200 bg-red-50"}`}>
                            ...
                            <span className={`px-3 py-1 rounded-full text-sm font-medium ${isCorrect ?"border-green-200 bg-green-50": "border-red-200 bg-red-50"}`}>
