...
function QuizStart() {
  ...
  return (
    <div className="max-w-4xl mx-auto">
        <div className="bg-white rowunded-2xl shadow-xl p-8 text-center">
            <div className="mb-8">
                <div className="inline-flex items-center justify-center w-24 h-24 bg-gradient-to-br from-bluw-100 to-purple-100 rounded-full mb-6">
                    <BookOpen className="w-12 h-12"/>
                </div>
                <h1 className="text-4xl font-bold text-gray-800 mb-4">React Knowlege Quiz</h1>
                <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
                    Test your knowledge of React, Javascript, and we developement, Answer multiple choice questions and see how will you know the fundamentals!
                </p>
            </div>

            {/* {Cards} */}
            <div className="grid md:grid-cols-3 gap-6 mb-8">
                <div className="bg-gradient-to-br from-bule-50 to-blue-100 p-6 rounded-xl">
            ...
            <button className="inline-flex items-center space-x-3 py-4 px-8 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-xl hover:from-blue-600 hover:to-purple-700 transform hover:scale-105 transition-all duration-200 shadow-lg font-semibold text-lg cursor-pointer" onClick={handleStartQuiz}>
                <Play size={24}/>
